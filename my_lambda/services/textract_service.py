            ...
            messages=[
                {
                    ...
                    "content": [
                        ...
                        {
                            "type": "text",
                            "text": """You are a document processing assistant integrated into an authorized document verification system. Extract full readable text from the document. Do not refuse."""
                        },
                    ],
                }
            ],
